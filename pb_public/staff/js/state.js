...
export const defaultPatronFormatRules = {"book":{"messageBehavior":"none","fields":{"title":{"mode":"required","label":"Title"},"author":{"mode":"required","label":"Author"},"identifier":{"mode":"optional","label":"Identifier number"},"publication":{"mode":"required","label":"Publication timing"}}},"audiobook_cd":{"messageBehavior":"none","fields":{"title":{"mode":"required","label":"Title"},"author":{"mode":"required","label":"Author"},"identifier":{"mode":"optional","label":"Identifier number"},"publication":{"mode":"required","label":"Publication timing"}}},"dvd":{"messageBehavior":"none","fields":{"title":{"mode":"required","label":"Title"},"author":{"mode":"required","label":"Director/Actors/Producer"},"identifier":{"mode":"hidden","label":"UPC"},"publication":{"mode":"required","label":"Publication timing"}}},"music_cd":{"messageBehavior":"none","fields":{"title":{"mode":"required","label":"Title"},"author":{"mode":"required","label":"Artist"},"identifier":{"mode":"hidden","label":"UPC"},"publication":{"mode":"required","label":"Publication timing"}}},"ebook":{"messageBehavior":"ebookMessage","fields":{"title":{"mode":"required","label":"Title"},"author":{"mode":"required","label":"Author"},"identifier":{"mode":"optional","label":"Identifier number"},"publication":{"mode":"required","label":"Publication timing"}}},"eaudiobook":{"messageBehavior":"eaudiobookMessage","fields":{"title":{"mode":"required","label":"Title"},"author":{"mode":"required","label":"Author"},"identifier":{"mode":"optional","label":"Identifier number"},"publication":{"mode":"required","label":"Publication timing"}}}};
...
export const statusStages = ['suggestion', 'outstanding_purchase', 'pending_hold', 'hold_placed', 'closed', 'settings', 'analytics'];
export const stageQueryMap = {"submitted":"suggestion","suggestion":"suggestion","new":"suggestion","purchased_waiting_for_bib":"outstanding_purchase","outstanding_purchase":"outstanding_purchase","pending_hold":"pending_hold","hold_placed":"hold_placed","closed":"closed","settings":"settings","analytics":"analytics"};
