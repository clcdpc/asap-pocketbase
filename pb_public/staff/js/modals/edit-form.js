...
export function renderPurchaseReminderOption(actionStr, ctx) {
  ...
  if (email) {
    ...
    help.appendChild(document.createTextNode('Add an email address to your '));
    const link = document.createElement('a');
    link.href = '#';
    link.className = 'js-open-profile-dialog';
    link.textContent = 'staff profile';
    help.appendChild(link);
    help.appendChild(document.createTextNode(' to email yourself purchase reminders.'));
  }
}
