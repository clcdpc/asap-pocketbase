...
const source = [
  "openEdit = function openEdit(id, nextStatus, dialogTitle, actionStr) {",
  ...
  "}",
  "",
  "staffProfileEmail = function staffProfileEmail() {",
  "  const model = pb.authStore.model || {};",
  "  return String(model.weekly_action_summary_email || '').trim();",
  "}",
  "",
  "renderPurchaseReminderOption = function renderPurchaseReminderOption(actionStr) {",
  ...
  "}",
  "",
  "renderEditPatronContext = function renderEditPatronContext(row) {",
  ...
  "}",
  "",
  "renderEditWorkflowTags = function renderEditWorkflowTags(tags) {",
  ...
  "}",
  "",
  "renderEditLeapBibLink = function renderEditLeapBibLink(bibId) {",
  ...
  "});",
  "",
  "setBibIdRequirement = function setBibIdRequirement(nextStatus) {",
