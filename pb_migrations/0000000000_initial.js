...
migrate((app) => {
  ...
  const systemSettings = saveCollection(app, {
    ...
    fields: [
      ...
      field("patronEmbedAllowedOrigins", "text", { max: 4096 }),
  ...
  const workflowSettings = saveCollection(app, {
    ...
    fields: [
      ...
      field("additionalCopyTimeoutEnabled", "bool"),
      field("additionalCopyTimeoutDays", "number", { onlyInt: true }),
  ...
  seedLookup(app, workflowTags, [
    ...
    { id: "tagdupesuggest0", code: "Duplicate suggestion", label: "Duplicate suggestion", description: "Another patron has a suggestion with the same identifier number." },
