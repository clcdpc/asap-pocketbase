...
function staffRunPromoterCheck(e) {
  ...
  try {
    var polarisInstance = require(`${__hooks}/lib/polaris.js`);
    var jobsInstance = require(`${__hooks}/lib/jobs.js`);
    var auth = polarisInstance.adminStaffAuth();
    var result = { promoted: 0 };
    jobsInstance.processOutstandingPurchases(e.app, auth, result);
