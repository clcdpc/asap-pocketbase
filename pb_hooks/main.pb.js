...
routerAdd("GET", "/api/asap/staff/assignable-users", (e) => {
  return require(`${__hooks}/../lib/staff_routes.js`).staffAssignableUsersList(e);
});
...
routerAdd("GET", "/api/asap/staff/material-types/sync", (e) => {
