...
export let authToken = sessionStorage.getItem('asap_patron_token') || '';
export function setAuthToken(token) {
  authToken = token || '';
  if (authToken) {
    sessionStorage.setItem('asap_patron_token', authToken);
  } else {
    sessionStorage.removeItem('asap_patron_token');
  }
}
