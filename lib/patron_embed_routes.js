...
const routeUtils = require(`${__hooks}/../lib/http_utils.js`);

function applyPatronFrameHeaders(e) {
  const headers = e.response.header();
  const ancestorUrl = routeUtils.requestHeader(e, "Referer") || routeUtils.requestHeader(e, "Origin");
  headers.set("Content-Security-Policy", config.patronEmbedFrameAncestors(e.app, ancestorUrl));
