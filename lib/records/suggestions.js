...
function createSuggestion(app, patronRecord, data, options) {
  ...
  let effectiveLibraryOrgId = String(options.effectiveLibraryOrgId || options.libraryOrgId || patronRecord.get("effectiveLibraryOrgId") || patronRecord.get("libraryOrgId") || "").trim();
  let effectiveLibraryOrgName = String(options.effectiveLibraryOrgName || options.libraryOrgName || patronRecord.get("effectiveLibraryOrgName") || patronRecord.get("libraryOrgName") || "").trim();
