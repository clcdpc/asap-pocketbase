...
function upsertPatronUser(app, patron, options) {
  ...
  var experienceLibraryOrgId = String(options.experienceLibraryOrgId || patron.experienceLibraryOrgId || "");
  var experienceLibraryOrgName = String(options.experienceLibraryOrgName || patron.experienceLibraryOrgName || "");
  var effectiveLibraryOrgId = String(options.effectiveLibraryOrgId || patron.effectiveLibraryOrgId || patronHomeLibraryOrgId || "");
  var effectiveLibraryOrgName = String(options.effectiveLibraryOrgName || patron.effectiveLibraryOrgName || patronHomeLibraryOrgName || "");
  ...
  record.set("experienceLibraryOrgId", experienceLibraryOrgId);
  record.set("experienceLibraryOrgName", experienceLibraryOrgName);
  record.set("effectiveLibraryOrgId", effectiveLibraryOrgId);
  record.set("effectiveLibraryOrgName", effectiveLibraryOrgName);
