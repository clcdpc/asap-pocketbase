...
function resolveStaffPatronByBarcode(e, staff, staffAuth, barcode, context, allowAnyRegisteredCardLogin, meta) {
  ...
  var patronRecord = records.upsertPatronUser(e.app, patronData, {
    experienceLibraryOrgId: effectiveLibraryOrgId,
    experienceLibraryOrgName: context ? context.libraryOrgName : "",
    effectiveLibraryOrgId: effectiveLibraryOrgId,
    effectiveLibraryOrgName: context ? context.libraryOrgName : ""
  });
