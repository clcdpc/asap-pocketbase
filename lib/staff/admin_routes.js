...
function resolvePolarisUpdateActor(staff, polarisConfig) {
  ...
  if (role === "super_admin") {
    return {
      polarisUserId: String((polarisConfig && polarisConfig.userId) || "").trim(),
...
function staffCreateSuggestion(e) {
  ...
  var pickupContext = pickupPreference.buildPickupPreferenceContext(e.app, staffAuth, patronData, { forceRefresh: true });
  var selectedBranch;
  try {
