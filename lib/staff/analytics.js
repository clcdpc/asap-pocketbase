...
module.exports = {
  ...
  fetchAnalyticsRecords: fetchAnalyticsRecords,
  loadAnalyticsSummary: loadAnalyticsSummary,
  loadFirstHoldPlacedEventTimes: loadFirstHoldPlacedEventTimes,
  loadFirstHoldPlacedEventTimesBatch: loadFirstHoldPlacedEventTimesBatch,
  holdPlacedEventTime: holdPlacedEventTime,
  compareAnalyticsDates: compareAnalyticsDates,
  ...
  analyticsLibraryOptions: analyticsLibraryOptions,
  analyticsLibraryLabel: analyticsLibraryLabel,
  emptyAnalyticsResponse: emptyAnalyticsResponse,
  dateInRange: dateInRange,
  daysBetween: daysBetween,
  parseAnalyticsDate: parseAnalyticsDate
};
