...
function getSettings(app) {
  ...
  return Object.assign({
    ...
    formatIconUrlPattern: sys ? sys.get("formatIconUrlPattern") || defaultFormatIconUrlPattern() : defaultFormatIconUrlPattern(),
...
function librarySettings(app, libraryOrgId) {
  ...
  return {
    ...
    formatIconUrlPattern: sys.get("formatIconUrlPattern") || defaultFormatIconUrlPattern()
  };
}

function formatIconUrlPattern(app) {
  var sys = getSystemSettings(app || $app);
  return sys ? sys.get("formatIconUrlPattern") || defaultFormatIconUrlPattern() : defaultFormatIconUrlPattern();
}
