...
function patronLogin(e) {
  ...
  try {
    ...
    var record = records.upsertPatronUser(e.app, patron, context);
...
function createSuggestion(e) {
  ...
  var effectiveLibraryOrgId = String(patron.get("effectiveLibraryOrgId") || patron.get("libraryOrgId") || "").trim();
  var effectiveLibraryOrgName = String(patron.get("effectiveLibraryOrgName") || patron.get("libraryOrgName") || "").trim();
  var uiText = config.uiText(e.app, effectiveLibraryOrgId);
  try {
