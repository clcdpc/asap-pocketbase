...
function updatePatronPreferredPickupBranch(staff, barcode, pickupBranchId, actor) {
  ...
  var body = helpers.buildXml("PatronRegistrationUpdateData", {
  ...
  var token = staff && staff.AccessToken ? String(staff.AccessToken) : "";
  var ep = helpers.endpoint(
    "protected",
    encodeURIComponent(token) + "/patron/" + encodeURIComponent(barcode) + "/registration"
  );
