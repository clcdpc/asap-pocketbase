...
function loadBranches(app, staffAuth, patronOrgId, options) {
  options = options || {};
  var cacheResult = pickupCache.getCachedPickupBranchesWithMeta(app, staffAuth, patronOrgId, options);
  return {
    branches: Array.isArray(cacheResult && cacheResult.branches) ? cacheResult.branches : [],
...
function buildPickupPreferenceContext(app, staffAuth, patron, options) {
  ...
  var cacheResult = loadBranches(app, staffAuth, patronOrgId, options);
