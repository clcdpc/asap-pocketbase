...
function normalizeFormatRules(rules, additionalFieldDefinitions) {
  rules = rules || {};
...
function sanitizePatronSuggestion(data, uiText) {
  ...
  var rules = normalizeFormatRules(uiText && uiText.formatRules, uiText && uiText.additionalFieldDefinitions);
