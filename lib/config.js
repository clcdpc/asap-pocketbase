...
function workflowRecord(app, orgId) {
  ...
  return systemRecord(app, "workflow_settings", "workflow0000010", {
    ...
    externalSearchLabel: "Search Amazon",
...
function workflowFromRecord(record) {
  return {
    ...
    externalSearchLabel: record.get("externalSearchLabel") || "Search Amazon",
    externalSearchUrlTemplate: record.get("externalSearchUrlTemplate") || "https://www.amazon.com/s?k={{title}}"
  };
}
