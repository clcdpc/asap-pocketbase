...
function sendAssignmentNotification(app, staff, record, actor) {
  ...
  var subject = "Assigned suggestion: " + title;
  
  var lines = [
    "Hello " + (staff.get("displayName") || staff.get("username")) + ",",
    "",
    actorName + " has assigned a suggestion to you:",
    "",
    "Title: " + title,
    "Author: " + (record.get("author") || "N/A"),
    "Format: " + (record.get("format") || "N/A"),
    "",
    "You can view and process this suggestion in the staff portal."
  ];

  var html = [
    "<p>Hello " + (staff.get("displayName") || staff.get("username")) + ",</p>",
    "<p><strong>" + actorName + "</strong> has assigned a suggestion to you:</p>",
    "<ul>",
    "<li><strong>Title:</strong> " + title + "</li>",
    "<li><strong>Author:</strong> " + (record.get("author") || "N/A") + "</li>",
    "<li><strong>Format:</strong> " + (record.get("format") || "N/A") + "</li>",
    "</ul>",
    "<p>You can view and process this suggestion in the staff portal.</p>"
  ];
