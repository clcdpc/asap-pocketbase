      ...
      (function() {
        ...
        C_enc.Base64 = {
          ...
          stringify: function(wordArray) {
            ...
            var result = base64Chars.join("");
            var mod = result.length % 4;
            if (paddingChar && mod) {
              return result.padEnd(result.length + 4 - mod, paddingChar);
            }
            return result;
          },
          /**
...
var require_enc_utf8 = __commonJS({
  "node_modules/crypto-js/enc-utf8.js"(exports2, module2) {
    (function(root, factory) {
      if (typeof exports2 === "object") {
        module2.exports = exports2 = factory(require_core());
      } else if (typeof define === "function" && define.amd) {
...
// bundle.js
var hmacSHA1 = require_hmac_sha1();
var Base64 = require_enc_base64();
var Utf8 = require_enc_utf8();
function hmacSha1Base64(secret, message) {
  return hmacSHA1(message, secret).toString(Base64);
}
function utf8Bytes(str) {
  var words = Utf8.parse(str).words;
  var sigBytes = Utf8.parse(str).sigBytes;
  var bytes = [];
  for (var i = 0; i < sigBytes; i++) {
