...
6. Perform short Astra High acceptance of the exact reviewed SHA, current receipts, clean review and branch/PR state. Require zero unresolved substantive Terra threads/summary findings and agreement with the journal. Do not duplicate successful implementation, review or tests. Keep allowed post-review acceptance documentation distinct from the reviewed implementation.
